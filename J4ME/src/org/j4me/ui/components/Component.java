...
public abstract class Component {
     ...
     * rounded edges.
     */
    public static final int HIGHLIGHTED_BORDER_WIDTH = 2; // original  : 2
    /**
     ...
     */
    public int horizontalAlignment = Graphics.LEFT;
    /**
    ...
    public final void paint(Graphics g, Theme theme, DeviceScreen screen,
            ...
            boolean selected) {
        //System.out.println("Enter component.paint() ");
    ...
    /**
     * Paints the component in grid using <code>g</code>.  The top-left corner is at (0,0)
     * and the component fills the rectangle bounded by <code>width</code> and
     * <code>height</code>. 
     * 
     * @param g is the <code>Graphics</code> object to be used for rendering the item.
     ...
     *  and <code>false</code> when it is not     .
     */
    public final void paintIcon(Graphics g, Theme theme, DeviceScreen screen,
     ...
     *  and <code>false</code> when it is not.
     */
    public abstract void paintComponent(Graphics g, Theme theme, int width, int height, boolean selected);
    ...
    public void repaint() {
        if (isShown() && (screen != null)) {
            // System.out.println("Component repaint");
            if (height != 0) {
     ...
     */
    public static int paintRect(Graphics g, Theme theme, int x, int y, int width, int height, boolean selected) {
