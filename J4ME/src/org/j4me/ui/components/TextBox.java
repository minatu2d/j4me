...
public class TextBox
     ...
     * there is no limit.
     */
    public int maxSize = DEFAULT_MAX_CHARS;
    /**
     ...
     * @see javax.microedition.lcdui.TextField
     */
    public int constraints = TextField.ANY;
     ...
     */
    public void setRestrictiveConstraint(int restriction) {
        // Keep the modifiers.
     ...
     */
    public void setModifierConstraint(int modifier, boolean on) {
        if (on) {
    ...
    public final class TextInput
         ...
         * The OK button.
         */
        public final Command ok;
        /**
         * The screen that invoked this one.
         */
        public final DeviceScreen parent;
        /**
         * The component this screen is collecting data for.
         */
        public final TextBox component;
