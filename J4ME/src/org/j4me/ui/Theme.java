...
import org.j4me.examples.ui.themes.BlueTheme;
...
public class Theme {
     ...
     */
    public static final double TITLE_BAR_SECONDARY_COLOR_MAX = 0.60;  // 60%
    /**
     * The percentage of the way down the menu bar that the secondary color
     * used in the gradient fill is at its max.
     */
    public static final double MENU_BAR_SECONDARY_COLOR_MAX = 0.10;  // 10%
    /**
     * The percentage of the way across the scrollbar that the secondary color
     * used in the gradient fill is at its max.
     */
    public static final double SCROLLBAR_SECONDARY_COLOR_MAX = 0.80;  // 80%
    /**
    ...
    public static Theme consoleTheme = null;
    public static Theme greenTheme = null;
    public static Theme blueTheme = null;
    ...
    public static Theme getDefaltTheme() {
        if (defaultTheme == null) {
            defaultTheme = new sunnetTheme();
        }
        return defaultTheme;
    }

    public static Theme getConsoleTheme() {
        if (consoleTheme == null) {
     ...
     * @see #paintTrackbar(Graphics, int, int, int, int)
     */
    public void paintTitleBarBackground(Graphics g, int x, int y, int width, int height) {
     ...
     * @see #paintMenuBar(Graphics, String, boolean, String, boolean, int, int)
     */
    public void paintMenuBarBackground(Graphics g, int x, int y, int width, int height) {
     ...
     * @see #paintTrackbar(Graphics, int, int, int, int)
     */
    public void paintScrollbarBackground(Graphics g, int x, int y, int width, int height) {
     ...
     */
    public void paintTrackbar(Graphics g, int x, int y, int width, int height) {
        // This code would paint the scrollbar a solid background.
    ...
    public String getMenuTextForOption() {
        return "Tùy chọn";
    }
